...
import (
	...
	"github.com/gkwa/hisarizona/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hisarizona.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".hisarizona")
	}
